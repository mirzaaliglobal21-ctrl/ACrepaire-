...
export const ReviewsAndTrust: React.FC = () => {
  ...
  return (
    <section id="why-us" className="py-16 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
            <div className="lg:col-span-7 p-6 sm:p-8">
              <div className="inline-flex items-center space-x-1.5 text-xs font-semibold text-teal-800 bg-teal-50 border border-teal-200 px-3 py-1 rounded-full mb-3">
            ...
            <div className="lg:col-span-5 relative h-64 sm:h-72 lg:h-full min-h-[260px] overflow-hidden bg-slate-100">
              <img 
        ...
        <div id="reviews">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
            ...
            <div className="inline-flex p-1 bg-white border border-slate-200 rounded-xl text-xs font-semibold shadow-2xs">
              <button
